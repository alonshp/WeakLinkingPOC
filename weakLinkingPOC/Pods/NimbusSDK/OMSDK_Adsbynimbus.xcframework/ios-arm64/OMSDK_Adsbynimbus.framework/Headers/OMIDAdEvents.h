 ...
 */
@interface OMIDAdsbynimbusAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDAdsbynimbusAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDAdsbynimbusVASTProperties *_Nonnull)vastProperties
