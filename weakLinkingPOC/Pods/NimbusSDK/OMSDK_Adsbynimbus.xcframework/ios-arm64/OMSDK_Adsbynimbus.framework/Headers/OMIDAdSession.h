 ...
 */
@interface OMIDAdsbynimbusAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDAdsbynimbusAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDAdsbynimbusAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDAdsbynimbusAdSessionContext *)context
