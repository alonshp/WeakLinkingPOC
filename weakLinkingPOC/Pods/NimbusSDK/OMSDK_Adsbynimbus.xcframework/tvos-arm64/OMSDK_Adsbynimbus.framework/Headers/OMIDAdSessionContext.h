 ...
 */
@interface OMIDAdsbynimbusAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDAdsbynimbusPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDAdsbynimbusPartner *)partner
                               ...
                               resources:(NSArray<OMIDAdsbynimbusVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
